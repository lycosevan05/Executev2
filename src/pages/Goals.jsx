...
export default function Goals() {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#f6f2e8' }}>
      {/* Header */}
      <div className="sticky top-0 z-40 px-5 pt-4 pb-3" style={{ background: 'rgba(251,248,241,0.95)', backdropFilter: 'blur(24px)', borderBottom: '1px solid #e8e1d4', paddingTop: 'max(1rem, calc(env(safe-area-inset-top) + 1rem))' }}>
